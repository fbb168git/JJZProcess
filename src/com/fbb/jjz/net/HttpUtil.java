...
//            	LogUtil.screenLog(key + "--->" + map.get(key));
     ...
     */
    public static String sendHtpps(String url, String params) throws ServerDisableException {
        return sendHtpps(url,params, null, true);
    }
    
    public static String sendHtpps(String url, String params, String referer) throws ServerDisableException {
        return sendHtpps(url,params, referer, true);
    }
    
    public static String sendHtpps(String url, String param, String referer, boolean useMobile) throws ServerDisableException {
        String result = "";
        PrintWriter out = null;
        BufferedReader in = null;
        ...
        try {
            ...
            if(responseCode != 200) {
                throw new ServerDisableException(responseCode);
            }

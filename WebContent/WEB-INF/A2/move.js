...
var bannerUrl = 'https://cms.zhongchebaolian.com/cmsforbjmobile/';
var userid = '';
var type0ne = '',typeTwo = '', typeThree = '';
...
//			 displayAdvertising();
//		 }
//		 if(url.indexOf('enterbj/win.jsp')>0){
//			 displayAdvertising();
//		 }
////	 }    
...
//	 userid = "5154FC40C38E4634848E87F30120FB8A4"
//	getPaperCount(userid,"3");
//	if (appsource != 'jjzx') {
//		var userid = "5154FC40C38E4634848E87F30120FB8A4"
//		getPaperCount(userid,"1");
//		getPaperCount(userid,"2");
//		console.log(userid)
//		
...
//	}
//}
//function getPaperCount(userId,adtype) {
//	var data = {
//			"userid": userId,
//			"adtype": adtype
//	}
...
//	$.ajax({
//		type:"post",
//		url:bannerUrl+ "/v1/ads/getAdInfo.do",
//        contentType: 'application/json;charset=utf-8',
//        dataType: "json",
//        data: data,
//		success:function(msg){
//			if(msg.rescode==200){
//				console.log(msg.advertisementflag)
//				if(msg.advertisementflag =='true'){
//					if(adtype == 1){
//						$(".dec").append('	<img id="homePageImg" data-link="'+msg.outerurl+'" src="'+msg.adurl+'"  style="width: 100%" />');
//						if(msg.outerurl !=''){
//							 
...
//		                                $.ajax({
//		                                    url: bannerUrl + '/v1/ads/adsCount.do',
//		                                    type: 'post',
//		                                    contentType: 'application/json;charset=utf-8',
//		                                    dataType: "json",
//		                                    data:dataParam,
...
//		                                    }
//		                                });
////	    						bridge.callHandler('pushViewController',{'type':100,'url':msg.outerurl});
//	    					});
//						}
//					}else if(adtype == 2){
//						$(".imgBox").removeClass("none");
//						$("#adDiv").html('<img id="adImg" src="'+msg.adurl+'" alt="" style="width: 100%" />');
//						if(msg.outerurl !=''){
//							  var dataParamone = {
//	                                    "userid":userId,
//	                                    "adid":msg.adid
//	                                }
//							  dataParamone = JSON.stringify(dataParamone)
//	                                $.ajax({
//	                                    url: bannerUrl + '/v1/ads/adsCount.do',
//	                                    type: 'post',
//	                                    contentType: 'application/json;charset=utf-8',
...
//						}
//					}else if(adtype == 3){
//						$(".turn_bm").removeClass("none");
//						$(".turn_bm").html('<img id="turn_xc" src="'+msg.adurl+'" alt="" style="width: 100%" />');
//						if(msg.outerurl !=''){
//							  var dataParamone = {
//	                                    "userid":userId,
//	                                    "adid":msg.adid
...
//					if(adtype == 2){
//						$(".imgBox").html("")
//						$(".imgBox").addClass("none");
//					}
//					if(adtype == 3){
//						$(".turn_bm").html("")
//						$(".turn_bm").addClass("none");
//					}
//				}
//			}
//		},
...
//    	openloading();
    ...
    function displayAdvertising(){
    	bridge.callHandler('isLogin', '', function(response) {
			if(response!= null && response != undefined){
				var userIdThree = response.userid;
				getPaperCount(userIdThree,"3");
			}
		});
    	if (appsource != 'jjzx') {
    		bridge.callHandler('isLogin', '', function(response) {
    			...
    			if(msg.rescode==200){
    				...
    				if(msg.advertisementflag =='true'){
    					if(adtype == 1){
    						...
    						$(".dec").html('<img id="homePageImg" data-link="'+msg.outerurl+'" src="'+msg.adurl+'"  style="width: 100%" />');
    						if(msg.outerurl !=''){
    							$('#homePageImg').click(function(){
    								 var dataParam = {
    		                                    "userid":userId,
    					...
    					if(adtype == 1){
    						$(".dec").html('<img id="homePageImg" data-link="" src="../../static_resources/enterbj/images/jjzdefault.jpg"  style="width: 100%" />');
    						$(".dec").css("display","block");
    					}
    					if(adtype == 2){
    						$(".imgBox").html("")
...
//	   	 if (hiddentime != '') {
	    	...
	    	if(url.indexOf('jsp/enterbj/win.jsp')>0){
	    		 displayAdvertising();
	    	}
//		 }    
		$('#flushbtn').click(function(){
